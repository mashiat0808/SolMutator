...
| `coverage`    | Generates the coverage of the user provided test suite in ```\coverage```|  `node index.js coverage`|
...
* ```\coverage``` generated by ```node index.js coverage```

## To start the SolMutator UI
